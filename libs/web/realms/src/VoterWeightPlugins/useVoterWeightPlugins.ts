...
import queryClient from '@realms/hooks/queries/queryClient'
import { updateVoterWeight } from './lib/updateVoterWeight'
import { createVoterWeight } from './lib/createVoterWeight'
import { CalculatedWeight, PluginType, UseVoterWeightPluginsArgs, VoterWeightPlugins } from './lib/types'
import { createMaxVoterWeight } from './lib/createMaxVoterWeight'
import { updateMaxVoterWeight } from './lib/updateMaxVoterWeight'
import { useMintInfoByPubkeyQuery } from '@realms/hooks/queries/mintInfo'
...
import { useTokenOwnerRecordsDelegatedToUser } from '@realms/hooks/queries/tokenOwnerRecord'
 ...
 * @param args
 */
export const useVoterWeightPlugins = (args: UseVoterWeightPluginsArgs): UseVoterWeightPluginsReturnType => {
  ...
  const { result: calculatedVoterWeights } = useCalculatedVoterWeights({
    ...
    tokenOwnerRecords: [walletTokenOwnerRecord, ...(delegatedTokenOwnerRecords || [])].filter(
      Boolean,
