...
// import { MintMaxVoteWeightSource, MintMaxVoteWeightSourceType } from '@solana/spl-governance'
...
//
// export type TokenAccount = RawAccount
...
//     tokenName = info?.name ? info.name : abbreviateAddress(acc.extensions.mint.publicKey)
...
//     amount = formatMintNaturalAmountAsDecimal(acc.extensions.mint.account, acc?.extensions.mint.account.supply)
//   }
//   return {
//     account,
//     tokenName,
...
//   }
//
//   const fractionValue = new BigNumber(fraction).shiftedBy(MintMaxVoteWeightSource.SUPPLY_FRACTION_DECIMALS).toNumber()
//
...
//   return new BN(new BigNumber(amount.toString()).shiftedBy(SCALED_FACTOR_SHIFT).toString())
// }
//
// export function getInverseScaledFactor(amount: BN) {
//   return new BigNumber(amount.toNumber()).shiftedBy(-SCALED_FACTOR_SHIFT).toNumber()
// }
