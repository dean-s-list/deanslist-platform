...
export class UnrecognisedVoterWeightPluginClient extends Client<any> {
  ...
  async calculateVoterWeight(
    ...
    console.warn(
      `WARNING: Unrecognised voter weight plugin client used during calculateVoterWeight. Passing through the input voter weight of ${inputVoterWeight.toString()}`,
    )
  ...
  static async connect(
    ...
    programId: PublicKey,
    devnet = false,
  ): Promise<UnrecognisedVoterWeightPluginClient> {
